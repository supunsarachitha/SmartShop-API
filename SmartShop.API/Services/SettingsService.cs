...
namespace SmartShop.API.Services
{
    public class SettingsService : ISettingsService
    {
        ...
        public async Task<ApplicationResponse<Setting>> GetSettingByIdAsync(Guid id)
        {
            try
            {
        ...
        public async Task<ApplicationResponse<Setting>> UpdateSettingAsync(Guid id, Setting updatedSetting)
        {
        ...
        public async Task<ApplicationResponse<Setting>> DeleteSettingAsync(Guid id)
        {
            try
            {
                var setting = await _context.Settings.FindAsync(id);
